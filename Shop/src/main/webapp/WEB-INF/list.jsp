		...
		<div class="pc-header-nav">
			<div class="pc-header-con">
				<div class="fl pc-header-link">
					您好！，欢迎来天喵购物 <a href="login.html" target="_blank">请登录</a> <a
		...
		<div class="yHeader">
			...
			<div class="yNavIndex">
				<ul class="yMenuIndex" style="margin-left: 0">
					<li style="background: #d1201e"><a href="" target="_blank">天喵首页</a></li>
						...
						<ul>
							<c:forEach items="${list }" var="pro">
								...
								<li>
									...
									<div class="digit1">
										<a href="#sss"><img src="pic/${pro.pics[0].path}"
											width="100%"></a>
									</div>
									<div class="digit2">
										<a href="#">${pro.name} </a>
